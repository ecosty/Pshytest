...
/*
 * Función para alterar el bloque de registro de un usuario.
 */
...
/*
 * Función para alterar el diseño del bloque de login.
 */
function bartik_preprocess_user_login_block(&$vars) {
  
  $vars['form']['name']['#title'] = 'Número de Cédula';
  $vars['form']['pass']['#title'] = 'Contraseña';
